...
export const validateFsPickPathParams = compile(S.FsPickPathParamsSchema);
export const validateFsPickPathResult = compile(S.FsPickPathResultSchema);
export const validateSandboxExplainParams = compile(S.SandboxExplainParamsSchema);
export const validateSandboxExplainResult = compile(S.SandboxExplainResultSchema);
export const validateSandboxEntriesAddParams = compile(S.SandboxEntriesAddParamsSchema);
export const validateSandboxEntriesAddResult = compile(S.SandboxEntriesAddResultSchema);
export const validateSandboxRecreateParams = compile(S.SandboxRecreateParamsSchema);
export const validateSandboxRecreateResult = compile(S.SandboxRecreateResultSchema);
...
export const validatePluginsCatalogCategoriesParams = compile(
  S.PluginsCatalogCategoriesParamsSchema,
);
export const validatePluginsCatalogGetParams = compile(S.PluginsCatalogGetParamsSchema);
...
export const validateUpdateRunRecord = compile(S.UpdateRunRecordSchema);
export const validateUpdateRunResult = compile(S.UpdateRunResultSchema);
export const validateUpdateRunsGetParams = compile(S.UpdateRunsGetParamsSchema);
export const validateUpdateRunsGetResult = compile(S.UpdateRunsGetResultSchema);
export const validateUpdateRunsListParams = compile(S.UpdateRunsListParamsSchema);
export const validateUpdateRunsListResult = compile(S.UpdateRunsListResultSchema);
export const validateUpdateRunChangedEvent = compile(S.UpdateRunChangedEventSchema);
