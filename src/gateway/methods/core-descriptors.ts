...
export const CORE_GATEWAY_METHOD_SPECS = [
  ...
  ["users.listAuthLinks", "users", "operator.read", "2026.9"],
  ["users.listModelAccounts", "users", "operator.read", "2026.9"],
  ["users.selectModelAccount", "users", "operator.write", "2026.9"],
  ["users.linkAuthProfile", "users", "operator.admin", "2026.9"],
  ["users.unlinkAuthProfile", "users", "operator.write", "2026.9"],
  ["users.authConnect.start", "users", "operator.write", "2026.9"],
  ["users.authConnect.answer", "users", "operator.write", "2026.9"],
  ["users.authConnect.status", "users", "operator.write", "2026.9"],
  ["users.authConnect.cancel", "users", "operator.write", "2026.9"],
  ["users.authConnect.catalog", "users", "operator.write", "2026.9"],
  ...
  ["sessions.title.prepare", "sessions-title", "operator.write", "2026.9", CONTROL_PLANE_WRITE],
  ["users.mentionable", "users-mentionable", "operator.read", "2026.9", { startup: true }],
  ["mentions.list", "mentions", "operator.read", "2026.9", { startup: true }],
  // Dismissal only changes the caller's temporary Inbox, not session or shared state.
  ["mentions.dismiss", "mentions", "operator.read", "2026.9", { startup: true }],
  ...
  ["transcripts.list", "transcripts", "operator.read", "2026.9"],
  ["transcripts.get", "transcripts", "operator.read", "2026.9"],
  ["models.authOrderSet", "models-auth-order", "operator.admin", "2026.9", CONTROL_PLANE_WRITE],
