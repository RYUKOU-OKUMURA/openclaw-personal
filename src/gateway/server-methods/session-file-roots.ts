...
import { openWorkspaceRoot, statWorkspacePath, type WorkspaceRoot } from "./workspace-fs.js";
...
export function loadSessionFileRoot(params: { sessionKey: string; agentId?: string }) {
...
export async function loadBrowserRoots(
...
async function directoryRoot(params: {
  ...
  return {
    ...
    info: {
      ...
      available: stat?.isDirectory === true,
    },
  };
}
